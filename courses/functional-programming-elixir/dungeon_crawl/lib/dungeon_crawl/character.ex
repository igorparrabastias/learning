defmodule DungeonCrawl.Character do
  # We can reference types like String by accessing the t function from their modules.
  # It’s a common convention in Elixir to define the struct type with t.
